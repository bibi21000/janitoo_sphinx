# -*- coding: utf-8 -*-
#
# JanitOO documentation build configuration file, created by
...
version = _version.major()
# The full version, including alpha/beta/rc tags.
release = _version.janitoo_version

try:
    version = package.get_version()
    release = package.get_version()
except:
    traceback.print_exc()
...
htmlhelp_basename = 'JanitOOdoc'

try:
    htmlhelp_basename = '%sdoc'%package.get_name()
except:
    traceback.print_exc()
...
latex_documents = [
  ('index',
   'JanitOO.tex',
    u'JanitOO Documentation',
    u'Sebastien GALLET (bibi21000)',
    'manual'),
]
...
man_pages = [
    ('index', 'janitoo', u'JanitOO Documentation',
     [u'Sebastien GALLET (bibi21000)'], 1)
]
...
texinfo_documents = [
  ('index', 'JanitOO', u'JanitOO Documentation',
   u'Sebastien GALLET (bibi21000)', 'JanitOO', 'One line description of project.',
   'Miscellaneous'),
]
